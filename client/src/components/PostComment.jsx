...
const PostComment = ({ comment, onDeleteComment }) => {
  ...
  return <li className="singlePost__comment">
    ...
    {userId == comment?.creator?._id && <button className="singlePost__comment-delete-btn" onClick={deleteComment}> <FaRegTrashAlt/> </button>}
  </li>;
};
